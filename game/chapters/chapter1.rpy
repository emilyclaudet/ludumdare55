label chapter1:
    ...
    show drone at left with dissolve
    d "Welcome [player]!"
...
label chapter1a:
    ...
    n "You realize she's sitting on floor on a plush carpet, looking deep in thought."
...
label chapter1b:
    ...
    n "You feel frustrated, and you realize the magnitude of this job."
    menu chapter1bmenu:
        ...
        "Try tapping Cyra on the shoulder":
            b "HALT! You cannot approach her."
            jump chapter1bmenu
    ...
    menu cyraquestions:
        "Yes. Great you're finally talking to me directly.":
            c "I know it's bad social etiquette to not use human voice."
            c "I can handle my other tasks in parallel, but it does lower my efficiency slightly."
            c "I figured the trade off was worth it this time."
            jump cyraquestions
        "That's right. How do you feel talking to a mere human?":
    ...
    c "Anyway, it's kind of Seren to send you."
    c "You can head out if you wish. There's no need to keep telling me about the party."
    menu cyraquestions2:
        n "You think about what you should do next to persuade Cyra to go out."
        "Offer to take her out for a coffee.":
            ...
            n "The drone suddently zooms out of the room."
    ...
    n "Hardly 2 minutes later, the drone returns with two steaming hot drinks."
    show drone at right with dissolve
    d "Here are your drinks. Please let me know anything else I can do to assist you."
    n "You sit in silence, realizing how easy it must be for Cyra to justify never leaving the house."
    jump chapter2